...
<head>
    ...
    {{--    <link rel="stylesheet" href="/lte/css/adminlte.css"><!--end::Required Plugin(AdminLTE)--><!-- apexcharts -->--}}
...
{{--                pass: {{ $ }}--}}
                {{--                <input type="password" name="pass" size="5" value="" wire:model="pass"--}}
...
{{--                        {{ route('logout') }}--}}
                        <a
                            href="{{ route('logout') }}"
{{--                            wire:click="logout" --}}
                           class="w-full text-start cursor-pointer p-3"
                        >
{{--                            <x-dropdown-link>--}}
{{--                                {{ __('Log Out') }}--}}
                                Выйти
...
{{--                            <div class="dropdown-divider"></div>--}}
{{--                            <a href="#" class="dropdown-item"> <i class="bi bi-file-earmark-fill me-2"></i> 3 new--}}
{{--                                reports--}}
...
{{--    <aside class="app-sidebar bg-body-secondary collapse shadow show" id="menu1" data-bs-theme="dark"> <!--begin::Sidebar Brand-->--}}
{{--        <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="/" class="brand-link">--}}
{{--                <!--begin::Brand Image-->--}}
{{--                --}}{{--                <img src="/lte/assets/img/AdminLTELogo.png" alt="AdminLTE Logo"--}}
{{--                <img src="/logo1.png" alt="Marudi"--}}
{{--                     class="brand-image xopacity-75 xshadow">--}}
{{--                <!--end::Brand Image-->--}}
{{--                <!--begin::Brand Text-->--}}
{{--                --}}{{--                <span class="brand-text fw-light">Marudi</span>--}}
{{--                <!--end::Brand Text--> </a>--}}
